...
- You should also add a reasonable padding to the video.
- And make sure graphs don't get cut off at the bottom!!!!
- Long text sentence should usually break after a few words, like aroudn 5 words per line, usually after commas. Never use '\n' inside Tex/MathTex. Always break lines using LaTeX's \\ command.

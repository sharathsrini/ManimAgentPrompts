...
3. Preserve existing objects, most layout logic (unless it violates the Text safety heuristic—do fix issues if necessary), and naming conventions.
...
8. AGAIN, YOU ARE ALLOWED TO APPLY THE **Text safety heuristic (mental checklist).**
   For every Text / Tex / MathTex you create:
   - Place it relative to something (next_to, to_edge, aligned_edge).
   - Check it is inside x ∈ [-5, 5].
   - If it is near the right-most object, prefer BELOW or ABOVE the group instead of RIGHT.
